class CreateOrigSchema < ActiveRecord::Migration
    ...
    def change
        ...
        create_table 'seer_accounts' do |t|
            t.integer 'user_id'
            t.string 'name'
            t.string 'objectid'
            t.string 'owner_key'
        ...
        add_index 'seer_accounts', ['name'], name: 'index_seer_accounts_on_key', unique: true
        add_index 'seer_accounts', ['objectid'], name: 'index_seer_accounts_on_objectid', unique: true
        add_index 'seer_accounts', ['user_id'], name: 'index_seer_accounts_on_user_id'
