...
ActiveRecord::Schema.define(version: 1) do
  ...
  create_table "seer_accounts", force: :cascade do |t|
  ...
  add_index "seer_accounts", ["name"], name: "index_seer_accounts_on_key", unique: true, using: :btree
  add_index "seer_accounts", ["objectid"], name: "index_seer_accounts_on_objectid", unique: true, using: :btree
  add_index "seer_accounts", ["user_id"], name: "index_seer_accounts_on_user_id", using: :btree
